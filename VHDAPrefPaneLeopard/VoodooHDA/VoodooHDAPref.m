...
- (void) didUnselect
{
//	NSLog( @"didUnselect ENTER");
	[super didUnselect];
	[self saveSettings];
//	NSLog( @"didUnselect EXIT");
}
...
/*	bytesWritten = [NSPropertyListSerialization writePropertyList:outerSettings
	...
	NSData *data = [NSPropertyListSerialization dataFromPropertyList:outerSettings
															  format:NSPropertyListBinaryFormat_v1_0
	...
	BOOL ok = [data writeToFile:nPath atomically:YES];
